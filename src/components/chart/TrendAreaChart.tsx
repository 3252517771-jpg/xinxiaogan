...
function TrendAreaChart({ dimension = 'overall' }: TrendAreaChartProps) {
  ...
  return (
    <div className="relative h-64 min-h-64 overflow-hidden rounded-glass border border-white/12 bg-black/14 p-4">
      <AreaChart data={data} height={224} margin={{ bottom: 4, left: -20, right: 10, top: 12 }} width={920}>
        <defs>
