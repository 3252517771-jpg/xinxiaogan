...
const DEFAULT_GLOW_COLOR = '168, 255, 180'
...
export function MagicBentoCard({
  ...
  return (
    <div className={`magic-bento-card magic-bento-card--border-glow relative overflow-hidden ${className}`} ref={cardRef} style={style}>
      {children}
    </div>
  )
}
...
function MagicBento({
  ...
  return (
    <>
        ...
        {`
          ...
          .magic-bento-card--border-glow::after {
            ...
            background: radial-gradient(
              ...
              rgba(${glowColor}, calc(var(--glow-intensity) * 0.78)) 0%,
      ...
      <div className={`magic-bento-section relative select-none ${className}`} data-react-bits="MagicBento" ref={gridRef}>
        {children}
      </div>
    </>
  )
